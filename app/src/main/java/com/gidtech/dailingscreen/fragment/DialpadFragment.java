package com.gidtech.dailingscreen.fragment;
...
import com.gidtech.dailingscreen.customView.Dialpad;
import com.gidtech.dailingscreen.customView.DigitsEditText;
...
//        }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(getActivity()).get(DialViewModel.class);
        mViewModel.getNumber().observe(this, s -> {
            if (!s.equals(mNumberText)) {
                setNumber(s);
            }
        });
        mPhoneNumberFormattingTextWatcher = new PhoneNumberFormattingTextWatcher(Utils.sLocale.getCountry());
...
//        Toast.makeText(this.getContext(), "new call", Toast.LENGTH_SHORT).show();
    }
